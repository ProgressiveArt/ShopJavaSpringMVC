...
<body>
<main>
    <h1 id=topzag>Bucket</h1>


    <span class="but"
          onclick="location.href='/user/shopPage'">Back</span>
        ...
        <c:forEach var="product" items="${productsList}">
            <tr>
                ...
                <td class="pole" style="border-right: 0px;"><span class="but"
                                                                  onclick="location.href='/user/bucketPage/delete/${product.id}'">Drop</span>
                </td>


                <td class="polePay" style="border-right: 0px;"><span class="but"
                                                                  onclick="location.href='/user/bucketPage/payOne/${product.id}'">Pay</span>
                </td>
            </tr>
        </c:forEach>
    </table>
    ...
    <td class="pole" style="border-right: 0px;"><span class="but"
                                                      onclick="location.href='/user/bucketPage/pay'">PayAll</span>
    </td>

    <td class="pole" style="border-right: 0px;"><span class="but"
                                                      onclick="location.href='/user/bucketPage/reset'">Reset</span>
    </td>
